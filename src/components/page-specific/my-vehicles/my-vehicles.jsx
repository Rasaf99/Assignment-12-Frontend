...
import MY_VEHICLE_CARD from "./my-vehicle-card/my-vehicle-card";


// functional component
export default function MY_VEHICLES() {
                ...
                (() => {
                    ...
                    if (isLoading) {
                        ...
                        return (
                            ...
                            <Typography variant='h4' sx={{textAlign:'center', color:'primary.main', marginTop:'1rem'}}> My Vehicles - Post </Typography>


                             <MY_VEHICLE_CARD successResponse={successResponse} refetch={fetchData}/>
