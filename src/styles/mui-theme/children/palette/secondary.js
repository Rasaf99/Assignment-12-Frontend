...
// in hsl, 14 is orange, 170 is teal
const light_1 = deepOrange[50]
const light_2 = deepOrange[100]
const light_3 = deepOrange[200]

const dark_1 = `hsl(14, 100%, 15%)`
const dark_2 = 'hsl(14, 100%, 20%)'
const dark_3 = 'hsl(14, 100%, 25%)'
